...
//1.2.
    ...
    // for(let x in product) console.log(x + ": " + product[x]);
//=================================================================================
...
//3.3
    // for(let item of jobSearch.hits) console.log(item);
//===============================================================================================================================================================
...
//4.1
    ...
    // let p = prompt("Enter a keyword");
    // let items = dictionary[p];
    // if(items != null) alert(`${p}\n` + items);
    // else alert(`We could not find your word: ${p}`);
//4.2
    // alert("Hi there, this is dev dictionary");
    // let p = prompt("Enter a keyword");
    // let items;
    // let init;
    // while(true){
    //     if(p == '') alert("You cannot leave it blank");
    ...
    //         else{
    //             while(true){
    //                 init = prompt("Update your dictionary");
    //                 if(init == '') alert("You must add dictionary");
    //                 else if(init == null){
...
//5.3
    // let init = prompt('Enter your category?');
    // let word = init.charAt(0).toUpperCase() + init.slice(1);
    // console.clear();
    // for(let items in product){
...
//5.5
/*
    let init = prompt("Enter provider");
    let word = init.charAt(0).toUpperCase() + init.slice(1);
    console.clear();
    for(let i = 0; i < product.length; i++){
        let listProvider = product[i].providers.split(' ');
        if(listProvider.indexOf(word) != -1){
            console.log('-------------------------------------------------');
...
/*
    ...
    let init;
    while(true){
        yourChoice = prompt('Enter your command (New, Delete, Update, Complete)');
        let yourChoice1 = yourChoice.toLowerCase();
        if(yourChoice1 == 'new'){
        ...
        else if(yourChoice1 == 'delete'){
            init = init = prompt('Enter position:');
            //c1
            delete front_end[init - 1];
            
            //c2
            //front_end.splice(init - 1, 1);//Cách 2 là xóa phần tử của mảng nên thứ tự của các tasks sẽ bị thay đổi
            for(let items in front_end){
                console.log((Number(items) + 1) + '. ' + front_end[items].name);
                console.log('Complete: ' + front_end[items].complete); 
            }
...
let front_end = {
    1: ['HTML', 'false'],
    2: ['CSS', 'false'],
    3: ['Basic of JavaScript', 'false'],
    4: ['Node Package Manager (npm)', 'false'],
    5: ['Git', 'false'],
};
    console.clear();
    console.log('Hi there, this is your learning tasks to front-end developer career:');
    for(let items in front_end){
        console.log(items + '. ' + '[ ] ' + front_end[items][0]);
    }
    console.log('------------------------------------------------------------------------------');
    console.clear();
    let init = prompt('Enter position');
    for(let items in front_end){
        if(items == init) console.log(items + '. ' + '[x] ' + front_end[items][0]);
        else console.log(items + '. ' + '[ ] ' + front_end[items][0]);
    }
    console.log('------------------------------------------------------------------------------');
*/
...
//15.4
    ...
    for(let items of jobData.hits[0].benefits) console.log('- ' + items.benefitValue);
